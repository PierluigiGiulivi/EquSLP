######################################################
# Data Analysis: 0+1*prime^(2^64) vs. 0+1*prime^(2^64)
######################################################
...
jpeg(file = 'all-0+1*prime^(2^64) vs. 0+1*prime^(2^64).jpg', res = 600, 
...
plot(x = total$bits,
     ...
     sub = "0+1*prime^(2^64) vs. 0+1*prime^(2^64)",
     xlab ="Number of Bits of Random Component", 
